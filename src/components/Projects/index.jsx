...
const projects = [
  {
    title: 'Jobby App',
    description:
      'Jobby is a job search platform with user authentication, job filters, detailed job listings.',
    technologies: ['React', 'JWT Auth', 'REST API'],
    link: 'https://jobbyrishabh.ccbp.tech',
    media: 'https://res.cloudinary.com/dvkzdok8c/image/upload/v1746998651/Screenshot_2025-05-12_024301_qccmwz.png',
  },
  {
    title: 'Nxt Trendz',
    description:
      'An e-commerce application featuring user authentication, product filters, cart management.',
    technologies: ['React', 'Context API', 'Routing'],
    link: 'https://rishabhnxttrend.ccbp.tech',
    media: 'https://res.cloudinary.com/dvkzdok8c/image/upload/v1746998912/Screenshot_2025-05-12_025816_h7vswd.png',
  },
  {
    title: 'GenAI ChatBot',
    description:
      'A conversational AI chatbot using OpenAI, LangChain, and Hugging Face, built with Gradio.',
    technologies: ['OpenAI', 'LangChain', 'Gradio'],
    link: 'https://yaaruaichatbox.ccbp.tech',
    media: 'https://res.cloudinary.com/dvkzdok8c/image/upload/v1746787008/Screenshot_2025-05-09_160029_rguql4_c_fill_ar_1_1_g_auto_icz3t8.png',
  },
  {
    title: 'Sticker Canvas',
    description:
      'React and Konva.js app that lets users add, move, resize, and layer stickers on a canvas.',
    technologies: ['React', 'Konva.js', 'Canvas'],
    link: 'https://my-sticker-app-3ae38.web.app/',
    media: 'https://res.cloudinary.com/dvkzdok8c/image/upload/v1749321289/Screenshot_2025-06-08_000425_l7f0te.png',
  },
  {
    title: 'GrowthPro AI',
    description:
    ...
    media: 'https://res.cloudinary.com/dvkzdok8c/image/upload/v1753444052/Screenshot_2025-07-25_171633_zrrj0r.png',
  },
  {
    title: 'MCP MegaWorkshop',
    description:
      'Interactive Streamlit project integrating YouTube, Google Drive, and Notion APIs.',
    technologies: ['Streamlit', 'Python', 'APIs'],
  ...
  },
  {
    ...
    media: 'https://res.cloudinary.com/dvkzdok8c/image/upload/v1746998828/Screenshot_2025-05-12_025650_oqhcxt.png',
  },
];
